...
/**
 * CallProcedureWithTokenAndCompany.java
 *
 ...
 */
            ...
            /**
            *  CallProcedureWithTokenAndCompany bean class
            */
       
        
        public  class CallProcedureWithTokenAndCompany
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = callProcedureWithTokenAndCompany
                ...
                */
				 ...
				 * 
				 */
				private static final long serialVersionUID = -5864020571679010791L;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":callProcedureWithTokenAndCompany",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static CallProcedureWithTokenAndCompany parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CallProcedureWithTokenAndCompany object =
                new CallProcedureWithTokenAndCompany();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"callProcedureWithTokenAndCompany".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CallProcedureWithTokenAndCompany)br.com.execBO.service.entities.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
